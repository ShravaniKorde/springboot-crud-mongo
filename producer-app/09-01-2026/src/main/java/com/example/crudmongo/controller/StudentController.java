...
public class StudentController {
    ...
    public StudentController(StudentService service, StudentKafkaProducer kafkaProducer) {
    ...
    public ResponseEntity<Student> create(@RequestBody Student student) {
        ...
        // 🔥 SEND EVENT TO KAFKA
        kafkaProducer.sendStudentEvent(
                "Student Created: " + student.getName() + " | " + student.getEmail()
        );
